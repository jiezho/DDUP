...
> 当前真实状态：受控 Markdown、权限优先 FTS5 和默认关闭的受保护混合检索实验路径已实现；仓库外 BGE-M3 synthetic-only 回环冒烟、独立合成盲测和 SourceVersion 精确 chunk 定位通过；重排与引用回答未实现
...
- 2026-08-26 最新验证：203/203 测试、独立生产构建、隐私扫描通过；最近一次 Playwright 1/1。
...
9. 扩展长文档、噪声、混合语言和提示注入边界集；通过后另设 Answer/Citation 启用门。
