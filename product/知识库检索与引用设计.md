...
> 当前真实状态：受控 Markdown、权限优先 FTS5、混合检索契约和合成评测基线已实现；真实向量召回、重排、引用回答均未实现
...
- 2026-08-25 最新验证：185/185 测试、生产构建、隐私扫描和 Playwright 1/1 通过。
...
2. 生成独立的“模型与运行时依赖审查_待确认”清单；未确认前使用确定性 Provider 完成契约与权限测试；**已完成，等待 G5a-D 确认**；
