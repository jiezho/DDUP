...
- S5-02/S5-03 已落地固定 Tool Registry、Task Candidate L1、L2 Approval/apply、scope digest、防替换、过期、幂等、ToolCall denied 审计、运行检查点、异常重启失败收敛、零工具副作用前提下的关联重试，以及正式运行中心与 SSE 断点续传；尚未落地通用 PolicyDecision、全域被拒访问审计、其他 Candidate/L2 动作、L3/L4、Runtime 私有 resume、密钥存储、备份恢复、到期清理和连接器安全；
