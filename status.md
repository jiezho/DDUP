...
- 验证：2026-09-15 前端包体门提交 `e5477e0` 与依赖清单提交 `330392d` 均已取得 GitHub Actions 7/7 远端证据，最新流水线 `34989283498`；入口 258.81 kB、最大分块 464.77 kB，原 1.55 MB 主包告警已消除。本地 275/275、隐私扫描与 Chromium/Firefox/WebKit 端到端各 1/1 通过。生产锁依赖机器清单可复现生成 349 项，其中 50 项需人工许可证/平台元数据复核。
